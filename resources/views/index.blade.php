...
<div class="rs-banner main-home">
    ...
    <div class="animate-part">
        <div class="spiner dot">
            <img class="rotate_Y" src="{{ asset('assets/images/banner/style1/dot-rect.png')}}" alt="images">
        </div>
        <div class="spiner tri-circle">
            <img class="up-down" src="{{ asset('assets/images/banner/style1/tri-circle1.png')}}" alt="images">
        </div>
        <div class="spiner circle">
            <img class="up-down" src="{{ asset('assets/images/banner/style1/circle1.png')}}" alt="images">
        </div>
        <div class="spiner line">
            <img class="up-down" src="{{ asset('assets/images/banner/style1/line1.png')}}" alt="images">
        </div>
    </div>
</div>
<!-- Banner Section End -->
        ...
        <div class="row y-middle">
            <div class="col-lg-6 md-mb-50">
                <div class="images-part">
                    <img src="{{ asset('assets/images/about/about.png')}}" alt="Images">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mb-55 col-md-6">
                <div class="services-item">
                    <div class="services-icon">
                        <img src="{{ asset('assets/images/services/main-home/1.png')}}" alt="Services">
                    </div>
            ...
            <div class="col-lg-4 mb-55 col-md-6">
                <div class="services-item">
                    <div class="services-icon">
                        <img src="{{ asset('assets/images/services/main-home/2.png')}}" alt="Services">
                    </div>
                    <div class="services-text">
            ...
            <div class="col-lg-4 mb-55 col-md-6">
                <div class="services-item">
                    <div class="services-icon">
                        <img src="{{ asset('assets/images/services/main-home/3.png')}}" alt="Services">
                    </div>
                    <div class="services-text">
            ...
            <div class="col-lg-4 md-mb-55 col-md-6">
                <div class="services-item">
                    <div class="services-icon">
                        <img src="{{ asset('assets/images/services/main-home/4.png')}}" alt="Services">
                    </div>
                    <div class="services-text">
            ...
            <div class="col-lg-4 sm-mb-55 col-md-6">
                <div class="services-item">
                    <div class="services-icon">
                        <img src="{{ asset('assets/images/services/main-home/5.png')}}" alt="Services">
                    </div>
                    <div class="services-text">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="services-item">
                    <div class="services-icon">
                        <img src="{{ asset('assets/images/services/main-home/6.png')}}" alt="Services">
                    </div>
                    <div class="services-text">
    ...
    <div class="container">
        ...
        <div class="row grid">
            <div class="col-lg-4 col-md-6 mb-30 grid-item filter1">
                <div class="project-item">
                    <div class="project-img">
                        <img src="{{ asset('assets/images/project/style1/1.jpg')}}" alt="images">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-30 grid-item filter3 filter1">
                <div class="project-item">
                    <div class="project-img">
                        <img src="{{ asset('assets/images/project/style1/2.jpg')}}" alt="images">
                    </div>
                    <div class="project-content">
                        <div class="project-inner">
                            <span class="category"><a href="project-single.html">Investment</a></span>
            ...
            <div class="col-lg-4 col-md-6 mb-30 grid-item filter2 filter4">
                <div class="project-item">
                    <div class="project-img">
                        <img src="{{ asset('assets/images/project/style1/3.jpg')}}" alt="images">
                    </div>
                    <div class="project-content">
                        <div class="project-inner">
            ...
            <div class="col-lg-4 col-md-6 md-mb-30 grid-item filter2 filter3">
                <div class="project-item">
                    <div class="project-img">
                        <img src="{{ asset('assets/images/project/style1/4.jpg')}}" alt="images">
                    </div>
                    <div class="project-content">
                        <div class="project-inner">
                            <span class="category"><a href="project-single.html">Business Strategy</a></span>
            ...
            <div class="col-lg-4 col-md-6 sm-mb-30 grid-item filter3 filter4">
                <div class="project-item">
                    <div class="project-img">
                        <img src="{{ asset('assets/images/project/style1/5.jpg')}}" alt="images">
                    </div>
                    <div class="project-content">
                        <div class="project-inner">
            ...
            <div class="col-lg-4 col-md-6 grid-item filter2 filter4">
                <div class="project-item">
                    <div class="project-img">
                        <img src="{{ asset('assets/images/project/style1/6.jpg')}}" alt="images">
                    </div>
                    <div class="project-content">
                        <div class="project-inner">
        ...
        <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false" data-nav-speed="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="true" data-center-mode="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="true" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="true">
            <div class="team-wrap">
                <div class="image-wrap">
                    <a href="team-single.html"><img src="{{ asset('assets/images/team/1.jpg')}}" alt="Team"></a>
            ...
            <div class="team-wrap">
                <div class="image-wrap">
                    <a href="team-single.html"><img src="{{ asset('assets/images/team/2.jpg')}}" alt="Team"></a>
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="team-wrap">
                <div class="image-wrap">
                    <a href="team-single.html"><img src="{{ asset('assets/images/team/3.jpg')}}" alt="Team"></a>
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="team-wrap">
                <div class="image-wrap">
                    <a href="team-single.html"><img src="{{ asset('assets/images/team/4.jpg')}}" alt="Team"></a>
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="col-lg-6">
                <div class="rs-videos choose-video">
                    <div class="images-video">
                        <img src="{{ asset('assets/images/choose/chosse-video.jpg')}}" alt="images">
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 md-mb-30">
                    <div class="services-item">
                        <div class="services-icon">
                            <img src="{{ asset('assets/images/choose/icons/1.png')}}" alt="Images">
                        </div>
                        <div class="services-text">
                ...
                <div class="col-lg-4 md-mb-30">
                    <div class="services-item">
                        <div class="services-icon">
                            <img src="{{ asset('assets/images/choose/icons/2.png')}}" alt="Images">
                        </div>
                        <div class="services-text">
                ...
                <div class="col-lg-4">
                    <div class="services-item">
                        <div class="services-icon">
                            <img src="{{ asset('assets/images/choose/icons/3.png')}}" alt="Images">
                        </div>
                        <div class="services-text">
        ...
        <div class="row y-middle">
            <div class="col-lg-6 md-mb-40">
                <div class="testi-image">
                    <img src="{{ asset('assets/images/testimonial/testi.png')}}" alt="Testimonial">
                </div>
            </div>
            <div class="col-lg-6 pl-60 md-pl-15">
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="30" data-autoplay="false" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-md-device="1" data-md-device-nav="false" data-md-device-dots="true" data-center-mode="false" data-ipad-device2="1" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-ipad-device="1" data-ipad-device-nav="false" data-ipad-device-dots="true" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="true">
                    <div class="testi-item">
                        ...
                        <div class="testi-content">
                            <div class="image-wrap">
                                <img src="{{ asset('assets/images/testimonial/avatar/1.jpg')}}" alt="Testimonial">
                            </div>
                    ...
                    <div class="testi-item">
                        ...
                        <div class="testi-content">
                            <div class="image-wrap">
                                <img src="{{ asset('assets/images/testimonial/avatar/2.jpg')}}" alt="Testimonial">
                            </div>
                            <div class="testi-information">
                    ...
                    <div class="testi-item">
                        ...
                        <div class="testi-content">
                            <div class="image-wrap">
                                <img src="{{ asset('assets/images/testimonial/avatar/3.jpg')}}" alt="Testimonial">
                            </div>
                            <div class="testi-information">
                    ...
                    <div class="testi-item">
                        ...
                        <div class="testi-content">
                            <div class="image-wrap">
                                <img src="{{ asset('assets/images/testimonial/avatar/4.jpg')}}" alt="Testimonial">
                            </div>
                            <div class="testi-information">
...
<div id="rs-blog" class="rs-blog blog-main-home bg7 pt-100 pb-100 md-pt-70 md-pb-70">
    <div class="container">
        ...
        <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="true" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-md-device="3" data-md-device-nav="false" data-md-device-dots="true">
            <div class="blog-item">
                <div class="image-wrap">
                    <a href="blog-details.html"><img src="{{ asset('assets/images/blog/1.jpg')}}" alt="Blog"></a>
                </div>
            ...
            <div class="blog-item">
                <div class="image-wrap">
                    <a href="blog-details.html"><img src="{{ asset('assets/images/blog/2.jpg')}}" alt="Blog"></a>
                </div>
                <div class="blog-content">
                    <ul class="blog-meta">
                        <li class="date">25 Jan 2021</li>
            ...
            <div class="blog-item">
                <div class="image-wrap">
                    <a href="blog-details.html"><img src="{{ asset('assets/images/blog/3.jpg')}}" alt="Blog"></a>
                </div>
                <div class="blog-content">
                    <ul class="blog-meta">
                        <li class="date">25 Jan 2021</li>
            ...
            <div class="blog-item">
                <div class="image-wrap">
                    <a href="blog-details.html"><img src="{{ asset('assets/images/blog/4.jpg')}}" alt="Blog"></a>
                </div>
                <div class="blog-content">
                    <ul class="blog-meta">
                        <li class="date">25 Jan 2021</li>
            ...
            <div class="blog-item">
                <div class="image-wrap">
                    <a href="blog-details.html"><img src="{{ asset('assets/images/blog/5.jpg')}}" alt="Blog"></a>
                </div>
                <div class="blog-content">
                    <ul class="blog-meta">
                        <li class="date">25 Jan 2021</li>
            ...
            <div class="blog-item">
                <div class="image-wrap">
                    <a href="blog-details.html"><img src="{{ asset('assets/images/blog/6.jpg')}}" alt="Blog"></a>
                </div>
                <div class="blog-content">
                    <ul class="blog-meta">
                        <li class="date">25 Jan 2021</li>
