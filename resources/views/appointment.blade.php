...
<body class="defult-home">
    ...
    <div class="main-content">
                                            ...
                                            <ul class="nav-menu">
                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="appointment.html">Appointment</a>
                                                        </li>
        ...
        <div class="rs-appointment style1 pt-100 md-pt-70">
            <div class="container">
                <div class="row y-middle mb-60">
                    ...
                    <div class="col-lg-7">
                        <p class="desc margin-0 pl-100 md-pl-15">30+ years experience in business and finance
                            consulting, IT solutions, and working with 5k+ clients over the world. Creation timelines
                            for the digital consulting business theme 2021.</p>
                    </div>
                </div>
            </div>
            <div class="border-section">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            <p class="margin-0 pr-28 md-pr-15">We denounce with righteous indignation in and dislike men
                                who are so beguiled and to demo realized by the charms of pleasure moment, so blinded by
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6 mb-30">
                                            <select name="consultation"
                                                ...
                                                <option value="Choose Consultation">Choose Consultation
                                                </option>
                                        ...
                                        <div class="col-lg-6 col-sm-6 mb-30">
                                            <input class="from-control" type="text" id="mm/dd/yyy" name="mm/dd/yyy"
        ...
        <!-- Team Section Start -->
        <div class="rs-team style1 pt-100 pb-100 md-pt-70 md-pb-70">
            <div class="container">
                <div class="row y-middle">
                    <div class="col-lg-6 mb-40 md-mb-30">
                        <div class="sec-title">
                            <h2 class="title">
                    ...
                    <div class="col-lg-6 text-right md-left md-mb-30">
                        <div class="btn-part">
                ...
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30"
                    ...
                    data-dots="false" data-nav="false" data-nav-speed="false" data-md-device="3"
                    ...
                    <div class="team-wrap">
                        ...
                        <div class="team-content">
                            <h3 class="team-name"><a href="#">Isabella Croline</a></h3>
                    ...
                    <div class="team-wrap">
                        ...
                        <div class="team-content">
                            <h3 class="team-name"><a href="#">Maria Masud</a></h3>
