...
<body class="defult-home">
    ...
    <div class="main-content">
            ...
            <div class="container">
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="0"
                    ...
                    <div class="slider-img">
                        <img src="assets/images/project/slide/1.jpg" alt="Slider">
                    </div>
                    <div class="slider-img">
                        <img src="assets/images/project/slide/2.jpg" alt="Slider">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 pr-60 md-pr-15">
                        <div class="sec-title mb-64">
                            ...
                            <p class="margin-0">European languages are members of the same family. The languages only
                                differ in their grammar, their pronu nciation and their most common words. pronunciation
                                and more common words. If several languages coalesce. over the years, sometimes by
                                accident, sometimes on purpose. Over the years, sometimes by accident, sometimes on
                                purpose. European languages are members of the same family. The languages only differ in
                                their grammar, their pronu nciation and their most common words. pronunciation and more
                                    ...
                                    <div class="col-lg-4">
                                        <div class="counter-area">
                                            ...
                                            <div class="content-part">
                                                <h5 class="title">Projects completed for our clients.</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="counter-area">
                                            ...
                                            <div class="content-part">
                                                <h5 class="title">Experienced serving to clients.</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="counter-area">
                                            ...
                                            <div class="content-part">
                                                <h5 class="title">Years experience in consulting.</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="project-information bg24">
                            <div class="sec-title">
                                ...
                                <div class="title-inner mb-25">
                                    <h4 class="title-small">Skills</h4>
                                    <p class="margin-0">Photoshop, illustrator</p>
                                </div>
                                <div class="title-inner mb-25">
                                    <h4 class="title-small">Client</h4>
                                    <p class="margin-0">John Dibag</p>
                                </div>
                                <div class="title-inner mb-25">
                                    <h4 class="title-small">Completed Date</h4>
                                    <p class="margin-0">20 - 04 - 2021</p>
                                </div>
                                <div class="title-inner mb-25">
                                    <h4 class="title-small">Manager</h4>
                                    <p class="margin-0">Marvelon Mizuk</p>
                                </div>
                                <div class="title-inner">
                                    <h4 class="title-small">Location</h4>
                                    <p class="margin-0">New York, NY, USA</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- About Section Start -->
        <div class="rs-about pb-110 md-pb-70">
            <div class="container">
                <div class="row y-middle">
                    <div class="col-lg-6 pr-50 md-pr-15">
                        <div class="sec-title">
                            ...
                            <p class="margin-0 pb-30">European languages are members of the same family. The languages
                                only differ in their grammar, their pronu nciation and their most common words.
                                sometimes by accident, sometimes on purpose. European languages are members of the same
                                family. </p>
                            <ul class="dots">
                            ...
                            <p class="margin-0">Pronunciation and more common words. If several languages coalesce. over
                                the years, sometimes by accident, sometimes on purpose. Over the years, sometimes by
                                purpose.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="images-part">
                            <img src="assets/images/project/pro-final.png" alt="Images">
                        </div>
                    </div>
                </div>
                <div class="final-outcome pt-100">
                    <div class="row y-middle">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 pl-50 md-pl-15">
                            <div class="sec-title">
                                ...
                                <p class="margin-0 pb-30">The languages only differ in their grammar, their pronu
                                    nciation and their most common words. sometimes by accident, sometimes on purpose.
                                    European languages are members of the same family european languages are members of
                                    the same family.</p>
                                <ul class="dots">
                                ...
                                <p class="margin-0">If several languages coalesce. over the years, sometimes by
                                    accident, sometimes on purpose. Over the years, sometimes by accident, on purpose.
                                    European languages are of the same family are members of the same family. </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 pl-55 md-pl-15">
