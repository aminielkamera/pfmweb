                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="last-item menu-item-has-children current-menu-item">
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li class="active"><a href="shop-single.html">Shop
                                                                        Single</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="single-price-info pl-30 sm-pl-0">
                            ...
                            <p class="some-text">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                ...
                <div class="tab-area">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="description" role="tabpanel"
                            ...
                            <p class="dsc-p">A product can be classified as tangible or intangible. A tangible product
                                is a physical object that can be perceived by touch such as a building, vehicle, gadget,
                                or clothing. An intangible product is a product that can only be perceived indirectly
                                such as an insurance policy</p>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 md-mb-45">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title pt-15"><a href="shop-single.html">Electronics Device</a>
                                </h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title pt-15"><a href="shop-single.html">Prescription Book</a>
                                </h2>
                                <span class="price">$30.00</span>
                            </div>
                        </div>
