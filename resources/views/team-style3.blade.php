...
<body class="defult-home">
    ...
    <div class="main-content">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="last-item menu-item-has-children current-menu-item">
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li class="active"><a href="team-style3.html">Team Style
                                                                        3</a></li>
        ...
        <!-- Team Start -->
        <div id="rs-team" class="rs-team style3 pt-100 pb-100 md-pt-70 md-pb-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    <div class="name">
                                        <a href="team-single.html">Jarmin Akter</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    <div class="name">
                                        <a href="team-single.html">Abdur Rashid</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    <div class="name">
                                        <a href="team-single.html">Natalie Martinez</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 md-mb-30">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    <div class="name">
                                        <a href="team-single.html">Mahabub Alam</a>
                                    </div>
                                    <span class="post">Founder & CEO</span>
                                </div>
                                <ul class="social-icon">
                    ...
                    <div class="col-lg-4 col-md-6 sm-mb-30">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    <div class="name">
                                        <a href="team-single.html">ibrahim Riaz</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    <div class="name">
                                        <a href="team-single.html">Maria Masud</a>
                                    </div>
