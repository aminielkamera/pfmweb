                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="last-item menu-item-has-children current-menu-item">
                                                            <a href="#">Team</a>
                                                            <ul class="sub-menu">
                                                                <li class="active"><a href="team-style1.html">Team Style
                                                                        1</a> </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="team-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-name"><a href="team-single.html">Johnny Depp</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 sm-mb-30">
                        <div class="team-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-name"><a href="team-single.html">Isabella Croline</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="team-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-name"><a href="team-single.html">Maria Masud</a></h3>
