        ...
        <div class="rs-breadcrumbs img4">
            <div class="container">
                <div class="breadcrumbs-inner">
                    <h1 class="page-title">
                        partners
                        <span class="watermark">partners</span>
                    </h1>
                ...
                <div class="row y-middle">
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="box-inner">
                            <div class="box-item">
                                <div class="icon-box">
                                    <a href="#"><img class="dance_hover" src="assets/images/partner/main-home/1.png"
                                            alt="Partner"></a>
                                </div>
                                <div class="text-area">
                                    <p class="services-txt"> We always provide people a complete solution focused of any
                                        business.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="box-inner">
                            <div class="box-item">
                                <div class="icon-box">
                                    <a href="#"><img class="dance_hover" src="assets/images/partner/main-home/2.png"
                                            alt="Partner"></a>
                                </div>
                                <div class="text-area">
                                    <p class="services-txt"> We always provide people a complete solution focused of any
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="box-inner">
                            <div class="box-item">
                                <div class="icon-box">
                                    <a href="#"><img class="dance_hover" src="assets/images/partner/main-home/3.png"
                                            alt="Partner"></a>
                                </div>
                                <div class="text-area">
                                    <p class="services-txt"> We always provide people a complete solution focused of any
                    ...
                    <div class="col-lg-4 col-md-6 md-mb-30">
                        <div class="box-inner">
                            <div class="box-item">
                                <div class="icon-box">
                                    <a href="#"><img class="dance_hover" src="assets/images/partner/main-home/4.png"
                                            alt="Partner"></a>
                                </div>
                                <div class="text-area">
                                    <p class="services-txt"> We always provide people a complete solution focused of any
                    ...
                    <div class="col-lg-4 col-md-6 sm-mb-30">
                        <div class="box-inner">
                            <div class="box-item">
                                <div class="icon-box">
                                    <a href="#"><img class="dance_hover" src="assets/images/partner/main-home/5.png"
                                            alt="Partner"></a>
                                </div>
                                <div class="text-area">
                                    <p class="services-txt"> We always provide people a complete solution focused of any
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="box-inner">
                            <div class="box-item">
                                <div class="icon-box">
                                    <a href="#"><img class="dance_hover" src="assets/images/partner/main-home/6.png"
                                            alt="Partner"></a>
                                </div>
                                <div class="text-area">
                                    <p class="services-txt"> We always provide people a complete solution focused of any
                ...
                <div class="row y-middle">
                    ...
                    <div class="col-lg-6">
                        <div class="btn-part text-right md-left">
                            <a class="readon consultant discover" href="about.html">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
