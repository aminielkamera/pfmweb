                                            ...
                                            <ul class="nav-menu">
                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="services-style2.html">Services Style
                                                                2</a></li>
                    ...
                    <div class="col-lg-4 col-md-6 mb-20">
                        <div class="service-wrap">
                            ...
                            <div class="content-part">
                                ...
                                <div class="desc">We denounce with indignation on and dislike men who are so begui led
                                    and demoralized data.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-20">
                ...
                <div class="row y-middle">
                    <div class="col-lg-6 md-mb-50">
                        <div class="contact-img">
                            <img src="assets/images/contact/computer.jpg" alt="Computer">
                        </div>
                    </div>
                    <div class="col-lg-6">
