                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="last-item menu-item-has-children current-menu-item">
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li class="active"><a href="team-single.html">Team
                                                                        Single</a></li>
                                                            </ul>
                                                        </li>
            ...
            <div class="container custom">
                <div class="btm-info-team">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="con-info">
                                <span class="designation-info">Creative Director</span>
                                <h2 class="title">John Mizuk</h2>
                                <div class="short-desc">
                                    ...
                                    tail. Keeping your eye on the ball while performing a deep dive
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-7 pr-55 md-pr-15">
                        <div class="project-con">
                            <h3>Biography</h3>
                            <p class="margin-0 pb-25">Bring to the table win-win survival strategies to ensure proactive
                                ...
                                generated content in real-time will have multiple touchpoints for offshoring. Capitalize
                                ...
                                communication.</p>
                            <p class="margin-0">User generated content in real-time will have multiple touchpoints for
                                offshoring. Capitalize on low hanging fruit to identify a ballpark value added activity
                    ...
                    <div class="col-lg-5 md-mt-55">
                        <h3 class="margin-0 pb-25">Professional Skills</h3>
                        <!-- Skillbar Section Start -->
                        <div class="rs-skillbar style1 team-single">
