                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-80 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Digital CC Camera</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 mb-80 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Digital Hand Watch</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 mb-80 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Digital Sound Mk</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 mb-80 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Droit Sound Mk</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 mb-80 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Electronics Device</a></h2>
                                <span class="price">$30.00</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-80 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Head Phone Pro</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 md-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Portable Sound Mk</a></h2>
                                <span class="price">$150.00</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 sm-mb-40">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Smart Device Pm</a></h2>
                                <span class="price">$50.00</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="product-list">
                            ...
                            <div class="content-desc text-center">
                                <h2 class="loop-product-title"><a href="shop-single.html">Smart Hand Watch</a></h2>
