                                    ...
                                    <ul class="rs-address-area">
                                        ...
                                        <li class="address-list">
                                            ...
                                            <div class="info-content">
                                                ...
                                                <div class="info-des"><a href="mailto:info@bizup.com">info@bizup.com</a></div>
                                            </div>
                                        </li>
                                        <li class="address-list">
                                            <div class="info-icon">
                        ...
                        <div class="content-part">
                            <div class="container">
                                <div class="slider-des">
                                    <div class="sl-subtitle">Business Consulting</div>
                                    <h1 class="sl-title"> We grow & manage<br> Your Business</h1>
                                </div>
            ...
            <div id="rs-services" class="rs-services style4 pt-95 pb-100 md-pt-65 md-pb-70">
                <div class="container">
                    <div class="sec-title text-center mb-60 md-mb-40">
                        ...
                        <h2 class="title title3">More than 30+ years we provide<br> business consulting</h2>                           
                    </div>
                    <div class="row">
