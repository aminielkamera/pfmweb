...
<body class="defult-home">
    ...
    <div class="main-content">
                                            ...
                                            <ul class="nav-menu">
                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="portfolio5.html">Portfolio Five</a>
                                                        </li>
        ...
        <div class="rs-project style5 pt-100 pb-100 md-pt-70 md-pb-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="project-single.html"><img src="assets/images/project/style1/1.jpg"
                                        alt="images"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="project-single.html"><img src="assets/images/project/style1/2.jpg"
                                        alt="images"></a>
                            </div>
                            <div class="project-content ">
                                <div class="vertical-middle">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="project-single.html"><img src="assets/images/project/style1/3.jpg"
                                        alt="images"></a>
                            </div>
                            <div class="project-content ">
                                <div class="vertical-middle">
                                    <div class="vertical-middle-cell">
                                        ...
                                        <span class="category"><a href="project-single.html">Business
                                                Strategy</a></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 md-mb-30">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="project-single.html"><img src="assets/images/project/style1/4.jpg"
                                        alt="images"></a>
                            </div>
                            <div class="project-content ">
                                <div class="vertical-middle">
                    ...
                    <div class="col-lg-4 col-md-6 sm-mb-30">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="project-single.html"><img src="assets/images/project/style1/5.jpg"
                                        alt="images"></a>
                            </div>
                            <div class="project-content ">
                                <div class="vertical-middle">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="project-single.html"><img src="assets/images/project/style1/6.jpg"
                                        alt="images"></a>
                            </div>
                            <div class="project-content ">
                                <div class="vertical-middle">
