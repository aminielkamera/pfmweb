    ...
    <body class="home-6">
        ...
        <div class="main-content">
                ...
                <header id="rs-header" class="rs-header style2 header-transparent">
                    ...
                    <nav class="right_menu_togle hidden-md">
                        ...
                        <div class="canvas-logo">
                            <a href="index.html"><img src="assets/images/logo_light6.png" alt="logo"></a>
                        </div>
                    ...
                    <div class="row y-middle">
                        <div class="col-lg-5 col-md-7">
                            <div class="sec-title4 mb-30">
                                <div class="sub-title">Grow With Team</div>
                                <h2 class="title primary-color">Business</h2>
                ...
                <div class="container">
                    <div class="row service-wrap mr-0 ml-0">
                        <div class="col-lg-4 padding-0">
                            <div class="service-grid">
                                <div class="service-icon mb-23">
                                    <img src="assets/images/icons/head.svg" alt="">
                                </div>
                                <h4 class="title mb-18"><a href="#">Business Advice</a></h4>
                                <div class="desc mb-12">Phasellus dignissim, tellus into pellentesque mollis, mauris orci dignissim nisl id gravida.</div>
                                <div class="btn-wrap">
                        ...
                        <div class="col-lg-4 padding-0">
                            <div class="service-grid">
                                <div class="service-icon mb-23">
                                    <img src="assets/images/icons/data-processing.svg" alt="">
                                </div>
                                <h4 class="title mb-18"><a href="#">Data Processing</a></h4>
                                <div class="desc mb-12">Phasellus dignissim, tellus into pellentesque mollis, mauris orci dignissim nisl id gravida.</div>
                                <div class="btn-wrap">
                                    <a class="readmore" href="#">Read more <div class="btn-arrow"></div></a>
                                </div>
                        ...
                        <div class="col-lg-4 padding-0">
                            <div class="service-grid br-none bdru">
                                <div class="service-icon mb-23">
                                    <img src="assets/images/icons/risks.svg" alt="">
                                </div>
                                <h4 class="title mb-18"><a href="#">Risk Management</a></h4>
                                <div class="desc mb-12">Phasellus dignissim, tellus into pellentesque mollis, mauris orci dignissim nisl id gravida.</div>
                                <div class="btn-wrap">
                                    <a class="readmore" href="#">Read more <div class="btn-arrow"></div></a>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row service-wrap mr-0 ml-0">
                        ...
                        <div class="col-lg-4 padding-0 pr-1">
                            <div class="service-grid">
                                <div class="service-icon mb-23">
                                    <img src="assets/images/icons/branding.svg" alt="">
                                </div>
                                <h4 class="title mb-18"><a href="#">Brand Guideline</a></h4>
                                <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                                <div class="btn-wrap">
                                    <a class="readmore" href="#">Read more <div class="btn-arrow"></div></a>
                                </div>
                        ...
                        <div class="col-lg-4 padding-0">
                            <div class="service-grid">
                                <div class="service-icon mb-23">
                                    <img src="assets/images/icons/content-writing.svg" alt="">
                                </div>
                                <h4 class="title mb-18"><a href="#">Content Optimizing</a></h4>
                                <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                                <div class="btn-wrap">
                                    <a class="readmore" href="#">Read more <div class="btn-arrow"></div></a>
                                </div>
                        ...
                        <div class="col-lg-4 padding-0">
                            <div class="service-grid">
                                <div class="service-icon mb-23">
                                    <img src="assets/images/icons/clipboard.svg" alt="">
                                </div>
                                <h4 class="title mb-18"><a href="#">Business Strategy</a></h4>
                                <div class="desc mb-12">Integer at faucibus urna. Nullam condimentum leo id.</div>
                                <div class="btn-wrap">
                                    <a class="readmore" href="#">Read more <div class="btn-arrow"></div></a>
                                </div>
            ...
            <div class="rs-testimonial style1">
                <div class="secondary-bg2 left-radius relative pt-133 pb-133 md-pt-70 md-pb-70">
                    <div class="container">
                        <div class="sec-title4 text-center mb-60">
                            <div class="sub-title secondary-color mb-6">Testimonials</div>
                            <h2 class="title white-color">Customer Reviews</h2>
                        </div>
                        <div class="rs-carousel owl-carousel owl-loaded owl-drag" data-loop="true" data-items="3" data-margin="0" data-autoplay="true" data-autoplay-timeout="7000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="true" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="3" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="false">
                            <div class="item text-center">
                                ...
                                <div class="author-detail">
                                    <div class="desc">"Aenean non accumsan ante. Duis et risus accumsan sem tempus porta nec sit amet est Sed ut euismod."</div>
                                    <h4 class="name">Nathan Hirsch</h4>
                            ...
                            <div class="item text-center">
                                ...
                                <div class="author-detail">
                                    <div class="desc">"Aenean non accumsan ante. Duis et risus accumsan sem tempus porta nec sit amet est Sed ut euismod."</div>
                                    <h4 class="name">Piter More</h4>
                                    <span class="designation">Business Planner</span>
                                </div>
                            </div>
                            <div class="item text-center">
                                <div class="testi-img">
                            ...
                            <div class="item text-center">
                                ...
                                <div class="author-detail">
                                    <div class="desc">"Aenean non accumsan ante. Duis et risus accumsan sem tempus porta nec sit amet est Sed ut euismod."</div>
                                    <h4 class="name">Jeson Thomas</h4>
                                    <span class="designation">Consultant</span>
                                </div>
                            </div>
                        </div>
                        <div class="pattern-img">
                            <img class="img1 common rotate-anim" src="assets/images/pattern/pattern1.png" alt="">
                            <img class="img2 common" src="assets/images/pattern/pattern2.png" alt="">
                            <img class="img3 common" src="assets/images/pattern/pattern3.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="rs-project" class="rs-project style1 pt-100 pb-100 md-pt-70 md-pb-70">
                <div class="container">
                    <div class="sec-title4 text-center mb-60">
                        <div class="sub-title secondary-color mb-6">Portfolios</div>
                        <h2 class="title">Completed Business Cases.</h2>
                    </div>
                    ...
                    <div class="row rs-vertical-middle">
                        <div class="col-lg-6 pr-0">
                            <div class="sec-title4 mb-35">
                                ...
                                <div class="desc left-line-v">
                                    <div class="draw-line start-draw"></div>
                                    Duis pretium gravida enim, vel maximus ligula fermentum a. Sed rhoncus eget ex id egestas. Nam nec nisl placerat, tempus erat a, condimentum metus. Curabitur nulla nisi.
                                </div>
                            </div>
                            <div class="rs-counter hover-box pt-35">
                                ...
                                <div class="rs-counter-list box-item active">
                                    ...
                                    <h3 class="counter-number">722</h3>
                                    <div class="counter-text">Projects Done</div>
                                </div>
                                <div class="rs-counter-list box-item">
                                    <div class="counter-icon"><i class="glyph-icon flaticon-best"></i></div>
                                    <h3 class="counter-number">125</h3>
                                    <div class="counter-text">Winning Awards</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 md-pt-50">
                            <div class="img-part">
                                <img src="assets/images/achievement/achievement.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row rs-vertical-middle">
                        <div class="col-lg-6">
                            <div class="image-part">
                                <img src="assets/images/estimate/estimate.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 md-pt-50">
                            <div class="sec-title4 mb-36">
                                <div class="sub-title mb-6">Estimate</div>
                            ...
                            <ul class="estimate-info">
                                <li>
                                    ...
                                    <p class="margin-0">Duis pretium gravida enim, vel maximus ligula fermentuma. Sed rhoncus eget ex id egestas. Nam nec nisl.</p>
                                </li>
                                <li>
                    ...
                    <div class="row rs-vertical-middle">
                        <div class="col-lg-7">
                            <div class="sec-title4">
                                <div class="sub-title secondary-color mb-6">Get a quote</div>
                        ...
                        <div class="col-lg-5 md-pt-30">
                            <div class="cta-btn text-center text-md-left">
                                <a class="readon2 hover-light" href="#">Get Started <div class="btn-arrow"></div></a>
                            </div>
                        </div>
                    </div>
                    <img class="pattern-right" src="assets/images/pattern/pattern5.png" alt="">
                    <img class="pattern-left" src="assets/images/pattern/pattern6.png" alt="">
                </div>
            </div>
            ...
            <div class="rs-pricing style2 pt-128 md-pt-70">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="pricing-wrap text-center">
                                <div class="head-part">
                                    ...
                                    <div class="price">$65<span class="period">/m</span></div>
                                </div>
                                <div class="body-part">
                                    <ul>
                                        <li>Competitor Analysys <i class="fa fa-check"></i></li>
                                        <li>Marketing Strategy <i class="fa fa-check"></i></li>
                                        <li class="no">Digital Marketing <i class="fa fa-times"></i></li>
                                        <li class="no">Marketing Strategy <i class="fa fa-times"></i></li>
                                        <li class="no">Competitor Analysys <i class="fa fa-times"></i></li>
                                    </ul>
                                    <div class="btn-part">
                        ...
                        <div class="col-md-4">
                            <div class="pricing-wrap active text-center">
                                <div class="head-part">
                                    <div class="title">Standard</div>
                                    <div class="price">$75<span class="period">/m</span></div>
                                </div>
                                <div class="body-part">
                                    <ul>
                                        <li>Competitor Analysys <i class="fa fa-check"></i></li>
                                        <li>Marketing Strategy <i class="fa fa-check"></i></li>
                                        <li>Digital Marketing <i class="fa fa-check"></i></li>
                                        <li class="no">Marketing Strategy <i class="fa fa-times"></i></li>
                                        <li class="no">Competitor Analysys <i class="fa fa-times"></i></li>
                                    </ul>
                                    <div class="btn-part">
                        ...
                        <div class="col-md-4">
                            <div class="pricing-wrap text-center">
                                <div class="head-part">
                                    ...
                                    <div class="price">$99<span class="period">/m</span></div>
                                </div>
                                <div class="body-part">
                                    <ul>
                                        <li>Competitor Analysys <i class="fa fa-check"></i></li>
            ...
            <div id="rs-contact" class="rs-contact main-home home5-contact-style pt-100 md-pt-70  extra-pb">
                <div class="container">
                    <div class="sec-title4 text-center mb-50">
                        <h2 class="title">
