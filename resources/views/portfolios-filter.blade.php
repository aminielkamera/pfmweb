                                            ...
                                            <ul class="nav-menu">
                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="portfolios-filter.html">Portfolios
                                                                Filter</a></li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item-has-children">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter1">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <a class="p-icon" href="project.html"><i class="custom-icon"></i></a>
                                <div class="project-inner">
                                    <span class="category"><a href="project.html">Investment</a></span>
                                    <h3 class="title"><a href="project.html">Business planning</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter3 filter1">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <a class="p-icon" href="project.html"><i class="custom-icon"></i></a>
                                <div class="project-inner">
                                    <span class="category"><a href="project.html">Strength solutions</a></span>
                                    <h3 class="title"><a href="project.html">Strength solutions</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter2 filter4">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <a class="p-icon" href="project.html"><i class="custom-icon"></i></a>
                                <div class="project-inner">
                                    <span class="category"><a href="project.html">Business Strategy</a></span>
                                    <h3 class="title"><a href="project.html">Business analytics</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 md-mb-30 grid-item filter2 filter3">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                ...
                                <div class="project-inner">
                                    <span class="category"><a href="project.html">Business Strategy</a></span>
                                    <h3 class="title"><a href="project.html">Stock market analysis</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 sm-mb-30 grid-item filter3 filter4">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <a class="p-icon" href="project.html"><i class="custom-icon"></i></a>
                                <div class="project-inner">
                                    <span class="category"><a href="project.html">Financial</a></span>
                                    <h3 class="title"><a href="project.html">Sales analysis</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 grid-item filter2 filter4">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <a class="p-icon" href="project.html"><i class="custom-icon"></i></a>
                                <div class="project-inner">
                                    <span class="category"><a href="project.html">Tax Consulting</a></span>
                                    <h3 class="title"><a href="project.html">Stock investments</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
